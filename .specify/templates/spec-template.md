...
- **FR-003**: Users MUST be able to highlight text in the documentation and trigger contextual Q&A via "Ask AI" tooltip
- **FR-004**: System MUST crawl Docusaurus /docs folder or parse sitemap.xml for content ingestion
- **FR-005**: System MUST chunk text and store in Qdrant Cloud with metadata including source URL/heading
